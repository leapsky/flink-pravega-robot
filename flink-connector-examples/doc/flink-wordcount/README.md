...
$ flink run -m localhost:6123 -c CozmoWriter lib/pravega-flink-examples-0.2.0-SNAPSHOT-all.jar --host localhost --port 9999 --controller tcp://localhost:9090
```
...
```
$ cd flink-examples/build/install/pravega-flink-examples
$ flink run -m localhost:6123 -c CozmoReader lib/pravega-flink-examples-0.2.0-SNAPSHOT-all.jar --controller tcp://localhost:9090
```
...
- In the **Entry Class** field, enter: ```CozmoWriter```
...
- in the **Entry Class** field, enter: ```CozmoReader```
