...
/*
 * At a high level, CozmoWriter reads from an external network socket,
 ...
 */
public class CozmoWriter {

// Logger initialization
    private static final Logger LOG = LoggerFactory.getLogger(CozmoWriter.class);

    // Application parameters
    //   host - host running netcat, default 127.0.0.1
    //   port - port on which netcat listens, default 9999
    //   stream - the Pravega stream to write data to, default examples/cozmo
    //   controller - the Pravega controller uri, default tcp://127.0.0.1:9090

    public static void main(String[] args) throws Exception {
        LOG.info("Starting CozmoWriter...");
        ...
        env.execute("CozmoWriter");

        LOG.info("Ending CozmoWriter...");
    }
